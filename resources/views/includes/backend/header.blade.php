...
<div class="header">
    <div class="header-primary">
        ...
        <div class="header-left">
            <a href="{{route('dashboard')}}" class="logo">
                <img src="{{!empty(app(App\Settings\ThemeSettings::class)->logo) ? asset('storage/settings/'.app(App\Settings\ThemeSettings::class)->logo):asset('/assets/img/logos/logo-demo2.png')}}" alt="logo" height="30">
            </a>
        </div>
        <!-- /Logo -->
    ...
    <div class="d-flex flex-direction-row  justify-content-between gap-2 header-secondary menu menu-row">
